...
**Hypothèse.** Le trafic suit des cycles réguliers selon l'heure, le jour de la semaine et le mois.
...
```{r q2-jour-mois, fig.width=10, fig.height=4}
...
**Résultat — validé.** Le trafic a bien un rythme : minimum nocturne (~3-5 h UTC), pic à 15 h UTC
(chevauchement Europe / Amérique du Nord) ; progression du lundi au vendredi, creux du samedi ;
saisonnalité estivale marquée (pic juillet-août).
...
**Hypothèse.** Les flux les plus denses se concentrent aux États-Unis, en Europe et en Asie de l'Est.
...
**Résultat — nuancé.** La densité est extrême aux États-Unis (réseau domestique très maillé) et forte en
Europe. De vastes zones (Afrique, Asie centrale) apparaissent peu connectées — ce qui reflète à la fois des
inégalités réelles **et** un biais de couverture des capteurs OpenSky. Contrairement à l'intuition, les
corridors dominants ne sont pas surtout des long-courriers mais des **liaisons régionales à haute fréquence**.
